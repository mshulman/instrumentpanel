      ...
      try {
        return (
          <svg key={id} height="100%" width="100%" viewBox="0 0 20 30" stroke="none">
            <text x="10" y="3" textAnchor="middle" fontSize="4" dominantBaseline="middle">{this.widgetLabel}</text>
            <text x="10" y="10" textAnchor="middle" fontSize={this.state.value.fontSizeDate} dominantBaseline="middle">{this.state.value.date}</text>
            <text x="10" y="23" textAnchor="middle" fontSize="17" dominantBaseline="middle">{this.state.value.time}</text>
          </svg>
        )
